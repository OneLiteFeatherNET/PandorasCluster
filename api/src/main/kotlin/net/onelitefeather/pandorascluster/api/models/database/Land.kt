...
import net.onelitefeather.pandorascluster.api.enum.Permission
...
import net.onelitefeather.pandorascluster.api.models.database.flag.getDefaultFlag
import net.onelitefeather.pandorascluster.api.models.database.player.LandMember
import net.onelitefeather.pandorascluster.land.player.LandPlayer
import net.onelitefeather.pandorascluster.api.models.database.position.HomePosition
...
data class Land(
    ...
    @OneToOne
    val homePosition: HomePosition? = null,
    ...
    fun hasMemberPermission(memberId: UUID, permission: Permission): Boolean {
        val bukkitPlayer = PlayerUtil.Instances.instance.getPlayer(memberId) ?: return false
